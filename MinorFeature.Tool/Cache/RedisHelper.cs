...
namespace MinorFeature.Tool.Cache
{
    ...
    public class RedisHelper
    {
        ...
        /// <summary>
        /// 系统自定义的Redis Key前缀，默认使用配置RedisConfig.SysCustomPrefix的值
        /// </summary>
        ...
        /// 保存一个对象
        /// </summary>
        /// <typeparam name="T">可序列化的实体类型</typeparam>
        ...
        /// 获取一个key的对象
        /// </summary>
        /// <typeparam name="T">可反序列化的类型</typeparam>
        /// <param name="key">Redis Key</param>
        /// <returns></returns>
        ...
        {
            if (value.HasValue == false) return default(T);//没有值返回默认值
